...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var t1 = A._setArrayType([], type$.JSArray_TodoItem),
        t2 = document,
        t3 = type$.InputElement._as(t2.querySelector("#todoInput")),
        t4 = type$.ButtonElement._as(t2.querySelector("#addTodoBtn")),
        t5 = type$.SpanElement;
      t2 = new A.TodoApp(t1, t3, t4, type$.UListElement._as(t2.querySelector("#todoList")), t5._as(t2.querySelector("#totalTodos")), t5._as(t2.querySelector("#completedTodos")));
      t5 = type$._ElementEventStreamImpl_MouseEvent;
      A._EventStreamSubscription$(t4, "click", t5._eval$1("~(1)?")._as(t2.get$_addTodo()), false, t5._precomputed1);
      t5 = type$._ElementEventStreamImpl_KeyboardEvent;
      A._EventStreamSubscription$(t3, "keypress", t5._eval$1("~(1)?")._as(t2.get$_handleEnterKey()), false, t5._precomputed1);
      t2._loadTodos$0();
    },
    TodoItem: function TodoItem(t0, t1, t2) {
      this.id = t0;
      this.text = t1;
      this.isCompleted = t2;
    },
    TodoApp: function TodoApp(t0, t1, t2, t3, t4, t5) {
      var _ = this;
      _._todos = t0;
      _._todoInput = t1;
      _._addTodoBtn = t2;
      _._todoList = t3;
      _._totalTodosSpan = t4;
      _._completedTodosSpan = t5;
    },
    TodoApp__renderTodo_closure: function TodoApp__renderTodo_closure(t0, t1) {
      this.$this = t0;
      this.todo = t1;
    },
    TodoApp__renderTodo_closure0: function TodoApp__renderTodo_closure0(t0, t1) {
      this.$this = t0;
      this.todo = t1;
    },
    TodoApp__deleteTodo_closure: function TodoApp__deleteTodo_closure(t0) {
      this.todo = t0;
    },
    TodoApp__updateStats_closure: function TodoApp__updateStats_closure() {
    },
    TodoApp__saveTodos_closure: function TodoApp__saveTodos_closure() {
    },
  ...
  A.TodoItem.prototype = {
    toJson$0() {
      return A.LinkedHashMap_LinkedHashMap$_literal(["id", this.id, "text", this.text, "isCompleted", this.isCompleted], type$.String, type$.dynamic);
    }
  };
  A.TodoApp.prototype = {
    _addTodo$1($event) {
      var newTodo, _this = this,
        t1 = _this._todoInput,
        t2 = t1.value,
        text = t2 == null ? null : B.JSString_methods.trim$0(t2);
      if (text != null && text.length !== 0) {
        newTodo = new A.TodoItem(B.JSInt_methods.toString$0(Date.now()), text, false);
        B.JSArray_methods.add$1(_this._todos, newTodo);
        _this._renderTodo$1(newTodo);
        B.InputElement_methods.set$value(t1, "");
        _this._updateStats$0();
        _this._saveTodos$0();
      }
    },
    _addTodo$0() {
      return this._addTodo$1(null);
    },
    _handleEnterKey$1($event) {
      if (type$.KeyboardEvent._as($event).key === "Enter")
        this._addTodo$0();
    },
    _renderTodo$1(todo) {
      var t3, t4, t5,
        t1 = document,
        t2 = t1.createElement("li");
      t2.toString;
      t2.className = "todo-item " + (todo.isCompleted ? "completed" : "");
      t2.setAttribute("data-id", todo.id);
      t3 = t1.createElement("span");
      t3.toString;
      B.SpanElement_methods.set$text(t3, todo.text);
      t4 = type$._ElementEventStreamImpl_MouseEvent;
      t5 = t4._eval$1("~(1)?");
      t4 = t4._precomputed1;
      A._EventStreamSubscription$(t3, "click", t5._as(new A.TodoApp__renderTodo_closure(this, todo)), false, t4);
      t1 = t1.createElement("button");
      t1.toString;
      B.ButtonElement_methods.set$text(t1, "Delete");
      t1.className = "delete-btn";
      A._EventStreamSubscription$(t1, "click", t5._as(new A.TodoApp__renderTodo_closure0(this, todo)), false, t4);
      t2.children.toString;
      A._ChildrenElementList__addAll(t2, type$.Iterable_Element._as(A._setArrayType([t3, t1], type$.JSArray_Element)));
      this._todoList.appendChild(t2).toString;
    },
    _deleteTodo$1(todo) {
      var _this = this,
        t1 = _this._todos,
        t2 = A._arrayInstanceType(t1)._eval$1("bool(1)")._as(new A.TodoApp__deleteTodo_closure(todo));
      if (!!t1.fixed$length)
        A.throwExpression(A.UnsupportedError$("removeWhere"));
      B.JSArray_methods._removeWhere$2(t1, t2, true);
      t1 = _this._todoList.querySelector('[data-id="' + todo.id + '"]');
      if (t1 != null)
        J.remove$0$x(t1);
      _this._updateStats$0();
      _this._saveTodos$0();
    ...
    _updateStats$0() {
      var t1 = this._todos,
        ...
        completedCount = new A.WhereIterable(t1, t2._eval$1("bool(1)")._as(new A.TodoApp__updateStats_closure()), t2._eval$1("WhereIterable<1>")).get$length(0);
      B.SpanElement_methods.set$text(this._totalTodosSpan, "Total: " + t1.length);
      B.SpanElement_methods.set$text(this._completedTodosSpan, "Completed: " + completedCount);
    },
    _saveTodos$0() {
      var t1 = this._todos,
        t2 = A._arrayInstanceType(t1),
        t3 = t2._eval$1("MappedListIterable<1,Map<String,@>>"),
        todosJson = A.List_List$of(new A.MappedListIterable(t1, t2._eval$1("Map<String,@>(1)")._as(new A.TodoApp__saveTodos_closure()), t3), true, t3._eval$1("ListIterable.E"));
      t3 = window.localStorage;
      t3.toString;
      t3.setItem("todos", B.C_JsonCodec.encode$2$toEncodable(todosJson, null));
    },
    _loadTodos$0() {
      var todosJson, t1, t2, t3, t4, t5, t6, todo, _this = this,
        storedTodos = window.localStorage.getItem("todos");
      if (storedTodos != null) {
        todosJson = type$.List_dynamic._as(B.C_JsonCodec.decode$2$reviver(0, storedTodos, null));
        t1 = _this._todos;
        B.JSArray_methods.clear$0(t1);
        t2 = _this._todoList;
        t2.children.toString;
        B.UListElement_methods._clearChildren$0(t2);
        for (t2 = J.get$iterator$ax(todosJson), t3 = type$.Map_String_dynamic; t2.moveNext$0();) {
          t4 = t3._as(t2.get$current());
          t5 = J.getInterceptor$ax(t4);
          t6 = A._asString(t5.$index(t4, "text"));
          t4 = A._asBool(t5.$index(t4, "isCompleted"));
          todo = new A.TodoItem(B.JSInt_methods.toString$0(Date.now()), t6, t4);
          B.JSArray_methods.add$1(t1, todo);
          _this._renderTodo$1(todo);
        }
        _this._updateStats$0();
      }
    }
  };
  A.TodoApp__renderTodo_closure.prototype = {
    call$1(_) {
      var t1, t2, todoElement;
      type$.MouseEvent._as(_);
      t1 = this.$this;
      t2 = this.todo;
      t2.isCompleted = !t2.isCompleted;
      todoElement = t1._todoList.querySelector('[data-id="' + t2.id + '"]');
      if (todoElement != null)
        J.get$classes$x(todoElement).toggle$2(0, "completed", t2.isCompleted);
      t1._updateStats$0();
      t1._saveTodos$0();
      return null;
    },
  ...
  A.TodoApp__renderTodo_closure0.prototype = {
    call$1(_) {
      type$.MouseEvent._as(_);
      return this.$this._deleteTodo$1(this.todo);
    },
    $signature: 5
  };
  A.TodoApp__deleteTodo_closure.prototype = {
    call$1(t) {
      return type$.TodoItem._as(t).id === this.todo.id;
    },
    $signature: 6
  };
  A.TodoApp__updateStats_closure.prototype = {
    call$1(todo) {
      return type$.TodoItem._as(todo).isCompleted;
    },
    $signature: 6
  };
  A.TodoApp__saveTodos_closure.prototype = {
    call$1(todo) {
      return type$.TodoItem._as(todo).toJson$0();
    },
    $signature: 16
  };
  (function aliases() {
  ...
  (function installTearOffs() {
    ...
    var _;
    _instance(_ = A.TodoApp.prototype, "get$_addTodo", 0, 0, null, ["call$1", "call$0"], ["_addTodo$1", "_addTodo$0"], 14, 0, 0);
    _instance_1_u(_, "get$_handleEnterKey", "_handleEnterKey$1", 15);
  })();
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.Iterable, A.ListIterator, A.WhereIterator, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A._StackTrace, A.Closure, A.MapBase, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.JSSyntaxRegExp, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A.AsyncError, A._FutureListener, A._Future, A._AsyncCallbackEntry, A.Stream, A._Zone, A.SetBase, A._LinkedHashSetCell, A._LinkedHashSetIterator, A.ListBase, A.Codec, A.Converter, A._JsonStringifier, A.StackOverflowError, A._Exception, A.FormatException, A.Null, A._StringStackTrace, A.StringBuffer, A.EventStreamProvider, A._EventStreamSubscription, A.ImmutableListMixin, A.FixedSizeListIterator, A.TodoItem, A.TodoApp]);
    _inheritMany(J.Interceptor, [J.JSBool, J.JSNull, J.JavaScriptObject, J.JavaScriptBigInt, J.JavaScriptSymbol, J.JSNumber, J.JSString]);
    _inheritMany(J.JavaScriptObject, [J.LegacyJavaScriptObject, J.JSArray, A.EventTarget, A.DomException, A.DomTokenList, A.Event, A._HtmlCollection_JavaScriptObject_ListMixin, A._NodeList_JavaScriptObject_ListMixin, A._Storage_JavaScriptObject_MapMixin, A.__NamedNodeMap_JavaScriptObject_ListMixin]);
    _inheritMany(J.LegacyJavaScriptObject, [J.PlainJavaScriptObject, J.UnknownJavaScriptObject, J.JavaScriptFunction]);
    _inherit(J.JSUnmodifiableArray, J.JSArray);
    _inheritMany(J.JSNumber, [J.JSInt, J.JSNumNotInt]);
    _inheritMany(A.Error, [A.LateError, A.TypeError, A.JsNoSuchMethodError, A.UnknownJsTypeError, A._CyclicInitializationError, A.RuntimeError, A.AssertionError, A._Error, A.JsonUnsupportedObjectError, A.ArgumentError, A.UnsupportedError, A.UnimplementedError, A.ConcurrentModificationError]);
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A._EventStreamSubscription_closure, A.TodoApp__renderTodo_closure, A.TodoApp__renderTodo_closure0, A.TodoApp__deleteTodo_closure, A.TodoApp__updateStats_closure, A.TodoApp__saveTodos_closure]);
    _inheritMany(A.TearOffClosure, [A.StaticClosure, A.BoundClosure]);
    _inherit(A._AssertionError, A.AssertionError);
    _inheritMany(A.MapBase, [A.JsLinkedHashMap, A._JsonMap]);
    _inheritMany(A.Closure2Args, [A.initHooks_closure0, A.MapBase_mapToString_closure, A._JsonStringifier_writeMap_closure, A.Storage_keys_closure]);
    ...
    _inheritMany(A.HtmlElement, [A.AnchorElement, A.AreaElement, A.ButtonElement, A.FormElement, A.InputElement, A.SelectElement, A.SpanElement, A.UListElement]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(~())", "@(@)", "Null()", "~(Object?,Object?)", "~(MouseEvent)", "bool(TodoItem)", "@(@,String)", "@(String)", "Null(@)", "Null(~())", "_Future<@>(@)", "~(String,String)", "~(Event)", "~([Event?])", "~(KeyboardEvent)", "Map<String,@>(TodoItem)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: Symbol("$ti")
  };
  A._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"LegacyJavaScriptObject","UnknownJavaScriptObject":"LegacyJavaScriptObject","JavaScriptFunction":"LegacyJavaScriptObject","AbortPaymentEvent":"Event","ExtendableEvent":"Event","AElement":"SvgElement","GraphicsElement":"SvgElement","AudioElement":"HtmlElement","MediaElement":"HtmlElement","HtmlDocument":"Node","Document":"Node","Window":"EventTarget","PointerEvent":"MouseEvent","CompositionEvent":"UIEvent","CDataSection":"CharacterData","Text":"CharacterData","MathMLElement":"Element","HtmlFormControlsCollection":"HtmlCollection","JSBool":{"bool":[],"TrustedGetRuntimeType":[]},"JSNull":{"TrustedGetRuntimeType":[]},"JSArray":{"List":["1"],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"Iterable":["1"]},"ArrayIterator":{"Iterator":["1"]},"JSNumber":{"num":[]},"JSInt":{"int":[],"num":[],"TrustedGetRuntimeType":[]},"JSNumNotInt":{"num":[],"TrustedGetRuntimeType":[]},"JSString":{"String":[],"TrustedGetRuntimeType":[]},"LateError":{"Error":[]},"EfficientLengthIterable":{"Iterable":["1"]},"ListIterable":{"Iterable":["1"]},"ListIterator":{"Iterator":["1"]},"MappedListIterable":{"ListIterable":["2"],"Iterable":["2"],"ListIterable.E":"2"},"WhereIterable":{"Iterable":["1"]},"WhereIterator":{"Iterator":["1"]},"NullError":{"TypeError":[],"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"Closure0Args":{"Function":[]},"Closure2Args":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"_CyclicInitializationError":{"Error":[]},"RuntimeError":{"Error":[]},"_AssertionError":{"Error":[]},"JsLinkedHashMap":{"MapBase":["1","2"],"LinkedHashMap":["1","2"],"Map":["1","2"],"MapBase.K":"1","MapBase.V":"2"},"LinkedHashMapKeyIterable":{"Iterable":["1"]},"LinkedHashMapKeyIterator":{"Iterator":["1"]},"_Error":{"Error":[]},"_TypeError":{"TypeError":[],"Error":[]},"_Future":{"Future":["1"]},"AsyncError":{"Error":[]},"_Zone":{"Zone":[]},"_RootZone":{"_Zone":[],"Zone":[]},"_LinkedHashSet":{"SetBase":["1"],"Set":["1"],"Iterable":["1"]},"_LinkedHashSetIterator":{"Iterator":["1"]},"MapBase":{"Map":["1","2"]},"SetBase":{"Set":["1"],"Iterable":["1"]},"_SetBase":{"SetBase":["1"],"Set":["1"],"Iterable":["1"]},"_JsonMap":{"MapBase":["String","@"],"Map":["String","@"],"MapBase.K":"String","MapBase.V":"@"},"_JsonMapKeyIterable":{"ListIterable":["String"],"Iterable":["String"],"ListIterable.E":"String"},"JsonUnsupportedObjectError":{"Error":[]},"JsonCyclicError":{"Error":[]},"int":{"num":[]},"AssertionError":{"Error":[]},"TypeError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"StackOverflowError":{"Error":[]},"_StringStackTrace":{"StackTrace":[]},"StringBuffer":{"StringSink":[]},"Element":{"Node":[],"EventTarget":[]},"KeyboardEvent":{"Event":[]},"MouseEvent":{"Event":[]},"Node":{"EventTarget":[]},"HtmlElement":{"Element":[],"Node":[],"EventTarget":[]},"AnchorElement":{"Element":[],"Node":[],"EventTarget":[]},"AreaElement":{"Element":[],"Node":[],"EventTarget":[]},"ButtonElement":{"Element":[],"Node":[],"EventTarget":[]},"CharacterData":{"Node":[],"EventTarget":[]},"FormElement":{"Element":[],"Node":[],"EventTarget":[]},"HtmlCollection":{"ListBase":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"Iterable":["Node"],"ListBase.E":"Node","ImmutableListMixin.E":"Node"},"InputElement":{"Element":[],"Node":[],"EventTarget":[]},"NodeList":{"ListBase":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"Iterable":["Node"],"ListBase.E":"Node","ImmutableListMixin.E":"Node"},"SelectElement":{"Element":[],"Node":[],"EventTarget":[]},"SpanElement":{"Element":[],"Node":[],"EventTarget":[]},"Storage":{"MapBase":["String","String"],"Map":["String","String"],"MapBase.K":"String","MapBase.V":"String"},"UIEvent":{"Event":[]},"UListElement":{"Element":[],"Node":[],"EventTarget":[]},"_NamedNodeMap":{"ListBase":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"Iterable":["Node"],"ListBase.E":"Node","ImmutableListMixin.E":"Node"},"_ElementCssClassSet":{"SetBase":["String"],"Set":["String"],"Iterable":["String"]},"_EventStream":{"Stream":["1"]},"_ElementEventStreamImpl":{"_EventStream":["1"],"Stream":["1"]},"FixedSizeListIterator":{"Iterator":["1"]},"CssClassSetImpl":{"SetBase":["String"],"Set":["String"],"Iterable":["String"]},"AttributeClassSet":{"SetBase":["String"],"Set":["String"],"Iterable":["String"]},"SvgElement":{"Element":[],"Node":[],"EventTarget":[]}}'));
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      JSArray_TodoItem: findType("JSArray<TodoItem>"),
